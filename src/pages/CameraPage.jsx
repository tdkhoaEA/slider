...
function CameraPage() {
    ...
    const uploadToS3 = useCallback(async () => {
        ...
        try {
            ...
            if (metadata.title)
                headers["x-amz-meta-title"] = encodeURIComponent(
                    metadata.title
                );
            if (metadata.subtitle)
                headers["x-amz-meta-subtitle"] = encodeURIComponent(
                    metadata.subtitle
                );
            if (metadata.experience)
                headers["x-amz-meta-experience"] = encodeURIComponent(
                    metadata.experience
                );
            if (metadata.achievement)
                headers["x-amz-meta-achievement"] = encodeURIComponent(
